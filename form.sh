...
srun -w osmium -c 20 --mem 30000 -J linearB python3 rand_linear.py ../geo-emb/pretrained-embeddings/first-100__source--GoogleNews-vectors-negative300.txt Word2Vec
